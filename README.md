...
|8.  |Vendor                   |I want to be able to select issues assigned to me or all issues, and filter by priority, status and client.|It will help me 
focus on certain types of issues, or issues of a particular client, as required.                   | 
...
|17. |A Client                 |I want to be able to keep an issue/feature from pubic view.                                          |I don't want and issue/feature appearing on the vendor list or other clients'lists until the details have been agreed internally.                     |
