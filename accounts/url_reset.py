...
# "from django.core.urlresolvers import reverse_lazy" is throwing an error. 
# Found following solution on stackoverflow (https://stackoverflow.com/questions/43139081/importerror-no-module-named-django-core-urlresolvers/54987875)
